...
public class Level_22_Sauce_Lab extends BaseTest {
	...
	@Parameters({"browserName","url","platForm","browserVersion"})
	@BeforeClass
	public void beforeClass(String browserName, String url, String platForm, String browserVersion) {

		driver = getBrowserDriverSauceLab(browserName, url, platForm, browserVersion);
