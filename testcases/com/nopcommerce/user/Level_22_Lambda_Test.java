...
public class Level_22_Lambda_Test extends BaseTest {
	...
	@Parameters({"browser","url","osName","browserVersion"})
	@BeforeClass
	public void beforeClass(String browserName, String url, String osName, String browserVersion) {

		driver = getBrowserDriverLambdaTest(browserName, url, osName, browserVersion);
